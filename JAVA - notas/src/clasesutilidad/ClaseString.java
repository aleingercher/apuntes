...
public class ClaseString {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Busca la primera diferencia, y devuelve la diferencia entre los codicos ASCII");
        System.out.println("Si son iguales, devuelve 0");
        ...
        System.out.println("devuelve BOOLEAN"); 
