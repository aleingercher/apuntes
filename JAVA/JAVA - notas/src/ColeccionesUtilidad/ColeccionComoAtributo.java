...
public class ColeccionComoAtributo {
    ...
    public ColeccionComoAtributo(ArrayList<String> libros, HashSet<Integer> numeros, HashMap<Integer, String> alumnos) {
        this.libros = libros;
        this.numeros = numeros;
        this.alumnos = alumnos;
    }

    public ColeccionComoAtributo() {
